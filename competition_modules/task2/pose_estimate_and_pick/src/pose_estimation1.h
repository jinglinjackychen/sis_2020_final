...
#include <geometry_msgs/PoseStamped.h>
#include <geometry_msgs/Pose.h>
#include "task2/task1out.h"
#include "task2/data.h"
#include "task2/pose_estimation.h"
...
class pose_estimation{
  ...
  private:
    ...
    bool serviceCb(task2::pose_estimation::Request &req, task2::pose_estimation::Response &res);
