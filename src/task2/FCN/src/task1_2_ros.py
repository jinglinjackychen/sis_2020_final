...
class task1_2(object):
 	def __init__(self):
		...
		self.n_class = 6
		model_dir = "/home/sis/sis_competition_2020/catkin_ws/src/task2/FCN/models"   # 
		model_name = "FCNs_dataset2_batch6_epoch499_RMSprop_lr0.0001.pkl"
		...
		self.MAXAREA = 18000
		self.MINAREA = 1000
		self.brand = ['lego' ,'duck' ,'doublemint', 'kinder', 'kusan']
	...
	def prediction_cb(self, req):
			...
			for c in cnts:
				if self.MAXAREA >= cv2.contourArea(c) >= self.MINAREA:
					...
					if shape is "rectangle":
						...
						rospy.loginfo("i = %d",i)
						rospy.loginfo("rect[2] = %f",angle)

						if i == 3:
							resp.angle_dou = angle
						elif i == 4:
							resp.angle_kin = angle
						elif i == 5:
							resp.angle_ku = angle
						else:
							rospy.loginfo(" ")
		...
		cv2.imwrite("/home/sis/sis_competition_2020/catkin_ws/src/res.jpg", show_img)
		cv2.imwrite("/home/sis/sis_competition_2020/catkin_ws/src/mask.jpg", mask2)
		cv2.imwrite("/home/sis/sis_competition_2020/catkin_ws/src/origin_mask.jpg", mask)
